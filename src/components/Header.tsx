...
const Header: React.FC = () => {
  ...
  return (
    ...
    >
      <div className="mx-auto flex w-full max-w-full items-center justify-between px-6 py-7 md:px-12 lg:px-[10vw]">
        <Link
          to="/"
          className="text-[15px] font-semibold uppercase tracking-[0.02em] text-black transition-opacity hover:opacity-60"
        >
          Minh Do
        </Link>
        ...
        <nav className="flex gap-8 md:gap-10">
          <Link
            to="/"
            className={`text-[12px] font-medium uppercase tracking-[0.18em] transition-opacity ${
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="text-[12px] font-medium uppercase tracking-[0.18em] text-black/45 transition-opacity hover:text-black/75"
          >
            Resume
          </a>
        </nav>
